...
//
function skeletonKeyControl(Player) {
...
skeletonKeyControl.prototype.initialize = function(Player){
...
skeletonKeyControl.prototype.tick = function(event){
...
skeletonKeyControl.prototype.handleKeyDown = function(event){
...
skeletonKeyControl.prototype.handleKeyUp = function(event){
    if (this.Hero.inControl()) {
        switch (event.keyCode) {
            case KEYCODE_W: ;
            case KEYCODE_UP: ;  
